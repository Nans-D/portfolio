<form id="formContact" class="row w-100">
    ...
    <div class="mb-3 col-12">
        <label for="message" class="form-label w-100">Message
            <textarea id="message" class="form-control" style="background:none; border:1px solid white; color:white;" name="message" rows=10 type="text" placeholder="Message"></textarea>
        </label>
    </div>
    <div class="col-auto">
